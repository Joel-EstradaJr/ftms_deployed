/**
 * Next.js API Route: /api/staff/operational-expenses
 * Proxies requests to backend /api/v1/staff/operational-expenses
 */
...
export async function GET(request: NextRequest) {
    try {
        ...
        console.log('[API Proxy] GET /api/staff/operational-expenses ->', url);
...
export async function POST(request: NextRequest) {
    try {
        ...
        console.log('[API Proxy] POST /api/staff/operational-expenses ->', url);
