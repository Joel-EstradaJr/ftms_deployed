/**
 * Next.js API Route: /api/staff/revenue/receivable-payment
 * Proxies requests to backend /api/v1/staff/bus-trip-revenue/receivable-payment
...
export async function POST(request: NextRequest) {
    try {
        const url = `${BACKEND_URL}/api/v1/staff/bus-trip-revenue/receivable-payment`;
        const body = await request.json();

        console.log('[API Proxy] POST /api/staff/revenue/receivable-payment ->', url);
