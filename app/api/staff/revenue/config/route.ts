/**
 * Next.js API Route: /api/staff/revenue/config
...
export async function GET(request: NextRequest) {
  try {
    const url = `${BACKEND_URL}/api/v1/staff/bus-trip-revenue/config`;

    console.log('[API Proxy] GET /api/staff/revenue/config ->', url);
...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.log('[API Proxy] PUT /api/staff/revenue/config ->', url);
