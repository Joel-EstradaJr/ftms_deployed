/**
 * Next.js API Route: /api/staff/rental-revenue/[id]
 * Proxies requests to backend /api/v1/staff/rental-revenue/:id
...
export async function GET(
    ...
    try {
        ...
        const url = `${BACKEND_URL}/api/v1/staff/rental-revenue/${id}`;

        console.log('[API Proxy] GET /api/staff/rental-revenue/[id] ->', url);
...
export async function PATCH(
    ...
    try {
        ...
        console.log('[API Proxy] PATCH /api/staff/rental-revenue/[id] ->', url);
