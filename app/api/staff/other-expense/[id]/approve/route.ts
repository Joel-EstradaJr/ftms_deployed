/**
 * Next.js API Route: /api/staff/other-expense/[id]/approve
 * Proxies POST to backend /api/v1/staff/other-expense/{id}/approve
 */
...
export async function POST(
    ...
    try {
        ...
        console.log('[Staff API Proxy] POST /api/staff/other-expense/:id/approve ->', url);
