/**
 * Next.js API Route: /api/staff/other-expense
 * Proxies requests to backend /api/v1/staff/other-expense
 */
...
export async function GET(request: NextRequest) {
    try {
        ...
        console.log('[API Proxy] GET /api/staff/other-expense ->', url);
...
export async function POST(request: NextRequest) {
    try {
        ...
        console.log('[API Proxy] POST /api/staff/other-expense ->', url);
