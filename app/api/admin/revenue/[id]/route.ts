/**
 * Next.js API Route: /api/admin/revenue/[id]
 * Proxies requests to backend /api/v1/admin/bus-trip-revenue/:id
...
export async function GET(
    ...
    try {
        ...
        const url = `${BACKEND_URL}/api/v1/admin/bus-trip-revenue/${id}`;

        console.log('[API Proxy] GET /api/admin/revenue/[id] ->', url);
...
export async function PATCH(
    ...
    try {
        ...
        console.log('[API Proxy] PATCH /api/admin/revenue/[id] ->', url);
