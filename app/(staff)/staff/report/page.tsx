...
import JournalEntryReport from '../../../(admin)/admin/report/journalEntry';
import IncomeStatementReport from '../../../(admin)/admin/report/incomeStatement';
import FinancialPositionReport from '../../../(admin)/admin/report/trialBalance';
...
const StaffReportPage = () => {
  ...
  if (loading) {
    return (
      <div className="card">
        <h1 className="title">Financial Reports (View Only)</h1>
        <Loading />
      </div>
    );
  }
